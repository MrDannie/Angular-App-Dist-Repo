...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataService = /** @class */ (function () {
                ...
                DataService.prototype.getCustomersPageOne = function (page, pageSize) {
                    var _this = this;
                    return this.http.get(this.baseUrl)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
                        _this.calculateCustomersOrderTotal(response);
                        var people = response.slice(page, pageSize);
                        return {
                            results: people,
                ...
                DataService.prototype.getCustomer = function (id) {
                    ...
                    return this.http.get(this.baseUrl)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
                        _this.calculateCustomersOrderTotal(response);
                        var result = response.filter(function (customer) { return customer.id === id; });
                        return result[0];
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
                };
                DataService.prototype.getStates = function () {
                    return this.http.get(this.stateUrl)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (states) {
                        return states;
                    }));
                };
                DataService.prototype.deleteCustomer = function (id) {
                    ...
                    return this.http.get(this.baseUrl)
                        ...
                        var newCustomerList = _this.deleteFunction(customers, id);
                    ...
                    try {
                        for (var customers_1 = __values(customers), customers_1_1 = customers_1.next(); !customers_1_1.done; customers_1_1 = customers_1.next()) {
                            ...
                            if (customer && customer.orders) {
                                var total = 0;
                                try {
                                    for (var _c = (e_2 = void 0, __values(customer.orders)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                        var order = _d.value;
                ...
                DataService.prototype.deleteFunction = function (customers, id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FilterService = /** @class */ (function () {
                ...
                FilterService.prototype.filter = function (filterBy, items) {
                    if (filterBy && items) {
                        var filteredList = items.filter(function (customer) { return customer.firstName.toLocaleLowerCase().indexOf(filterBy) !== -1 ||
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FilterTextboxComponent = /** @class */ (function () {
                ...
                Object.defineProperty(FilterTextboxComponent.prototype, "listFilter", {
                    get: function () {
