(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customer-customer-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerEditComponent = /** @class */ (function () {
                function CustomerEditComponent(route, dataService, router) {
                    this.route = route;
                    this.dataService = dataService;
                    this.router = router;
                    this.customer = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerOrderComponent = /** @class */ (function () {
                function CustomerOrderComponent(dataService, route) {
                    this.dataService = dataService;
                    this.route = route;
                }
            ...
            CustomerOrderComponent.ctorParameters = function () { return [
