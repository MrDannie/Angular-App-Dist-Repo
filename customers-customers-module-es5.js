(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customers-customers-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomersCardComponent = /** @class */ (function () {
                function CustomersCardComponent() {
                    this.customers = [];
                }
            ...
            var CustomersComponent = /** @class */ (function () {
                ...
                CustomersComponent.prototype.getCustomersPage = function (page) {
                    ...
                    this.dataService.getCustomersPageOne((page - 1) * this.pageSize, this.pageSize * page)
                        ...
                        _this.customers = _this.filteredCustomers = customers.results;
                        _this.totalRecord = customers.totalRecord;
                    });
                };
                CustomersComponent.prototype.performFilter = function (filterBy) {
                    var item = this.customers;
                    this.filterFunction(filterBy, item);
                };
                CustomersComponent.prototype.filterFunction = function (filterBy, customers) {
